...
return [
    ...
    */
    'route' => [
        'checkOrder' => [
            // 'url' => '/kassa/checkOrder',
            'url' => env('YANDEX_KASSA_CHECK_URL', '/kassa/checkOrder'),
            //'action' => [
            //    'middleware' => 'web'
            //]
        ],
        'cancelOrder' => [
            // 'url' => '/kassa/cancelOrder'
            'url' => env('YANDEX_KASSA_CANCEL_URL', '/kassa/cancelOrder'),
        ],
        'paymentAviso' => [
            // 'url' => '/kassa/paymentAviso',
            'url' => env('YANDEX_KASSA_AVISO_URL', '/kassa/paymentAviso'),
        ]
    ],
];
